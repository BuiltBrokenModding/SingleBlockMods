...
{
    public static final ResourceLocation textureDoubleChest = new ResourceLocation(FilteredChests.DOMAIN, "textures/entity/chest/grey_scale_double.png");
    public static final ResourceLocation textureChest = new ResourceLocation(FilteredChests.DOMAIN, "textures/entity/chest/grey_scale.png");
